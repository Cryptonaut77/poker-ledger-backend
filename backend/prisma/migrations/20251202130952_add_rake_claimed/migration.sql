...
INSERT INTO "new_dealer_down" ("dealerName", "gameSessionId", "id", "rake", "timestamp", "tips", "tipsPaid") SELECT "dealerName", "gameSessionId", "id", "rake", "timestamp", "tips", "tipsPaid" FROM "dealer_down";
