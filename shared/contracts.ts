...
export const getActiveGameResponseSchema = z.object({
  ...
  userTotalGamesCreated: z.number(),
});
...
export const gameSummarySchema = z.object({
  ...
  creditBalance: z.number(), // Total credit owed by all players (player -> house)
  iouBalance: z.number().default(0), // Total IOUs the house owes back to players (house -> player)
});
