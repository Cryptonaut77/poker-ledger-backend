...
const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "4. Select payment method:",
      "   • Cash - Pay with physical money (reduces Till Balance)",
      "   • Electronic - Pay via Venmo/Zelle/etc. (tracked separately)",
      "   • IOU - Player leaves without payment (creates credit owed TO you)",
      "5. If player has unpaid credit, it auto-settles first before paying",
  ...
  },
  {
    ...
    content: [
      "• Till Balance - Physical cash on hand (Cash buy-ins + Paid credit debts - Cashouts - Paid tips - Expenses)",
      "• House Profit - Business profit (Claimed rake - Expenses)",
      "• Payment Method Balances - Shows net balance for each payment type",
      "• Cash (In Till) - Net cash that should be physically in the till",
      "• Electronic - Net electronic transactions (Venmo, Zelle, etc.)",
      "• Credit (Owed) - Total amount still owed by players on credit",
    ],
  },
  {
    title: "Credit/IOU System",
    content: [
      "When a player buys in on credit:",
      "• The amount is tracked as owed (unpaid debt)",
      "• No cash changes hands, so Till Balance is unaffected",
      "• Credit balance increases by the buy-in amount",
      "",
      "When they pay their credit debt:",
      "• Tap 'Mark as Paid' on the credit buy-in transaction",
      "• This means they paid cash to settle their debt",
      "• Till Balance INCREASES (cash received)",
      "• Credit balance DECREASES (debt cleared)",
      "",
      "When they cash out with credit owed:",
      "• Credit is automatically settled first from their winnings",
      "• Example: Owes $500, cashes out $800 → You pay $300 cash",
      ...
      "• When you later pay them, mark the transaction appropriately",
    ],
  },
  {
